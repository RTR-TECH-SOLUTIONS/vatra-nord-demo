...
export const TESTIMONIALE = [
  {
    ...
    legendaPoza: 'Casa familiei Ionescu pe lotul 1 din Corbeanca Nord, la un an de la cumpărare.',
  },
  {
    id: 'andrei-m',
    nume: 'Andrei M.',
  ...
  },
  {
    ...
    legendaPoza: 'Lotul 2 din Corbeanca Nord, șarpanta pusă în vara asta.',
  },
  {
    id: 'cristina-si-radu',
