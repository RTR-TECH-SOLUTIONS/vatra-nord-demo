 ...
 * nu ajută pe nimeni.
 *
 * `suprafata` și `pretMp` sunt cât are terenul și cât se cere pe metru pătrat.
 * Din ele iese prețul total, ca filtrele de buget și de suprafață să lucreze și
 * pe portofoliu, nu doar pe loturile din parcelări.
 *
